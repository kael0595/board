...
import com.example.demo.answer.model.AnswerForm;
import com.example.demo.comment.model.CommentForm;
...
public class QuestionController {
  ...
  public String questionCreate(@Valid QuestionForm questionForm,
    ...
    this.questionService.create(questionForm, siteUser, files);
